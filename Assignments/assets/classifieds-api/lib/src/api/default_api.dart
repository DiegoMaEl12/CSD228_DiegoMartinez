...
import 'dart:convert';
import 'package:classifieds_api/src/deserialize.dart';
...
class DefaultApi {
  ...
  Future<Response<void>> listingsDelete({
    ListingsDeleteRequest? listingsDeleteRequest,
    ...
    try {
      _bodyData = jsonEncode(listingsDeleteRequest);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [List<ClassifiedsListing>] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<List<ClassifiedsListing>>> listingsGet({
    ListingsGetRequest? listingsGetRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      _bodyData = jsonEncode(listingsGetRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
    ...
    List<ClassifiedsListing>? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<List<ClassifiedsListing>, ClassifiedsListing>(
              rawData,
              'List<ClassifiedsListing>',
              growable: true,
            );
    } catch (error, stackTrace) {
      throw DioException(
    ...
    return Response<List<ClassifiedsListing>>(
      data: _responseData,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ClassifiedsListing] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ClassifiedsListing>> listingsPatch({
    ...
    try {
      _bodyData = jsonEncode(listingsUpdate);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
    ...
    ClassifiedsListing? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<ClassifiedsListing, ClassifiedsListing>(
              rawData,
              'ClassifiedsListing',
              growable: true,
            );
    ...
    return Response<ClassifiedsListing>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [ClassifiedsListing] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ClassifiedsListing>> listingsPost({
    ...
    try {
      _bodyData = jsonEncode(listingsPostRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [UsersDelete200Response] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<UsersDelete200Response>> usersDelete({
    ...
    try {
      _bodyData = jsonEncode(usersDeleteRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
    ...
    UsersDelete200Response? _responseData;

    try {
      final rawData = _response.data;
      _responseData = rawData == null
          ? null
          : deserialize<UsersDelete200Response, UsersDelete200Response>(
              rawData,
    ...
    return Response<UsersDelete200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  Future<Response<List<User>>> usersGet({
    ...
    try {
      _bodyData = jsonEncode(usersGetRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<User>> usersPatch({
    ...
    try {
      _bodyData = jsonEncode(usersPatchRequest);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
  ...
  Future<Response<User>> usersPost({
    ...
    try {
      _bodyData = jsonEncode(userDetails);
    } catch (error, stackTrace) {
      throw DioException(
        requestOptions: _options.compose(_dio.options, _path),
        type: DioExceptionType.unknown,
